...
import { ref } from "vue";
import commentSvg from "@/components/appProject/Inbox/commentSvg.vue";
import InputField from "@/components/UI/InputField.vue";
import buttonField from "@/components/UI/buttonField.vue";
import inputFile from "@/components/UI/inputFile.vue";
import comment from "@/components/appProject/Inbox/comment.vue";
const file = ref(null);
...
<template>
  ...
  >
    <div class="opacity-100 bg-white w-5/12 p-5 rounded-md">
      ...
      <div
        v-if="store.$state.commentClick"
        class="w-full rounded-lg border-2 border-gray-400 border-solid p-5"
      >
        <div>
          <input-field
