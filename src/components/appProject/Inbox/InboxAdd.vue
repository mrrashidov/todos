...
<template>
  <div class="
    ...
    <div class="w-full my-4">
      <div class="
        ...
        <span class="
              ...
              mx-2
            ">
          <svg class="mx-1 text-red-500 group-hover:text-white" width="13" height="13">
    ...
    <div class="w-full">
      <div v-if="true" @click="openSection" class="
            add-section
            w-full
            text-center
            cursor-pointer
      ...
      <div v-else class="section w-full">
        <input ref="input" type="text" placeholder="Name this section"
        ...
        <button @click="addSection" class="bg-red-600 py-2 px-3 my-2 text-white font-bold rounded-md">
          Add section
        </button>
        <button @click="cancelSection" class="mx-2 mt-2 py-2 px-3 hover:underline
            ">
          Cancel
        </button>
      </div>
    ...
    <div v-if="true" class="main w-full text-center ">
      <div class="lg:w-1/5 md:w-2/5 xl:w-1/5 2xl:w-1/5 w-1/2 mx-auto my-3">
        <svg data-svgs-path="theme_todoist/inbox_zero.svg" viewBox="0 0 220 200" xmlns="http://www.w3.org/2000/svg"
          ...
          <g transform="translate(-2050)">
            <g id="InboxZero">
              ...
              <path
                ...
                fill="#f9e4e2" transform="translate(-16671.478 -1287.763) scale(1.06068)"></path>
              <path
                ...
                fill="#fff" transform="matrix(.93816 0 0 .38164 -15623.476 -343.635)"></path>
              <path
                d="M18900 1167.23c0-3.99-1.3-7.23-2.9-7.23h-34.2c-1.6 0-2.9 3.24-2.9 7.23 0 4 1.3 7.24 2.9 7.24h34.2c1.6 0 2.9-3.24 2.9-7.24z"
                fill="#fff" transform="matrix(.95594 0 0 .38164 -15915.877 -343.635)"></path>
              <path
                d="M18900 1167.23c0-3.99-1.3-7.23-2.9-7.23h-34.2c-1.6 0-2.9 3.24-2.9 7.23 0 4 1.3 7.24 2.9 7.24h34.2c1.6 0 2.9-3.24 2.9-7.24z"
                fill="#fff" transform="matrix(-.95594 0 0 .38164 20274.403 -343.635)"></path>
              <path
                d="M18900 1167.23c0-3.99-4.5-7.23-10-7.23h-20c-5.5 0-10 3.24-10 7.23 0 4 4.5 7.24 10 7.24h20c5.5 0 10-3.24 10-7.24z"
                fill="#fff" transform="matrix(-.275 0 0 .38164 7387.045 -343.635)"></path>
              <path
                d="M18900 1167.23c0-3.99-1.7-7.23-3.7-7.23h-32.6c-2 0-3.7 3.24-3.7 7.23 0 4 1.7 7.24 3.7 7.24h32.6c2 0 3.7-3.24 3.7-7.24z"
                fill="#fff" transform="matrix(-1.23972 0 0 .6399 25512.315 -656.877)"></path>
              <path
                ...
                fill="#fff" transform="matrix(1.64828 0 0 .64036 -29000.906 -657.425)"></path>
              <ellipse cx="15804.9" cy="618.475" rx="10.066" ry="7.745" fill="#fff"
                transform="matrix(-1.56686 0 0 1.87728 26893.318 -1080.936)"></ellipse>
              <path d="M15804.9 610.729c5.6 0 10.1 3.471 10.1 7.746h-20.2c0-4.275 4.6-7.746 10.1-7.746z" fill="#fff"
                transform="matrix(-3.22859 0 0 4.12745 53186.476 -2458.803)"></path>
              <ellipse cx="15804.9" cy="618.475" rx="10.066" ry="7.745" fill="#fff"
                transform="matrix(-1.05711 0 0 1.29581 18813.8 -716.811)"></ellipse>
              <path
                d="M557.517 1647.1c.945.15 1.164 1.74-.1 1.81H528.5c-.987-.06-1.34-1.74 0-1.82h28.917c.033.01.066.01.1.01z"
                fill="#fff" fill-rule="nonzero" transform="matrix(1.0842 0 0 1.1043 1497.112 -1700.933)"></path>
              <path
                d="M567.467 1647.11c.675.2.699 1.72-.101 1.8H528.5c-.731-.08-.908-1.72 0-1.82h38.866c.034.01.067.01.101.02z"
                fill="#fff" fill-rule="nonzero" transform="matrix(1.47851 0 0 1.1043 1402.612 -1700.933)"></path>
              <path
                ...
                fill="#fff" fill-rule="nonzero" transform="matrix(.15438 0 0 1.1043 2145.873 -1695.283)"></path>
              <path d="M557.466 1647.12c.204.29.237 1.65-.049 1.79H528.5c-.236-.11-.281-1.68 0-1.82h28.917l.049.03z"
                fill="#fff" fill-rule="nonzero" transform="matrix(4.55063 0 0 1.1043 -314.136 -1695.413)"></path>
              <path
                d="M557.521 1647.1c.988.15 1.216 1.74-.104 1.81H528.5c-1.03-.06-1.4-1.74 0-1.82h28.917c.035.01.069.01.104.01z"
                fill="#fff" fill-rule="nonzero" transform="matrix(1.0381 0 0 1.1043 1557.822 -1700.933)"></path>
              <path
                d="M18900 1167.23c0-3.99-1.1-7.23-2.5-7.23h-35c-1.4 0-2.5 3.24-2.5 7.23 0 4 1.1 7.24 2.5 7.24h35c1.4 0 2.5-3.24 2.5-7.24z"
                fill="#fff" transform="matrix(-.87871 0 0 .30532 18707 -244.949)"></path>
              <path
                d="M18900 1167.23c0-3.99-4-7.23-8.8-7.23h-22.4c-4.8 0-8.8 3.24-8.8 7.23 0 4 4 7.24 8.8 7.24h22.4c4.8 0 8.8-3.24 8.8-7.24z"
                fill="#fff" transform="matrix(-.25 0 0 .30532 6948.474 -244.949)"></path>
              <path
                ...
                fill="#fff" transform="matrix(-.22534 0 0 .30532 6342.523 -244.949)"></path>
              <path
                ...
                fill="#fff" transform="matrix(-.8366 0 0 .30532 17995.698 -244.949)"></path>
              <path
                ...
                fill="#fff" transform="matrix(1.47695 0 0 .64036 -25678.298 -657.975)"></path>
              <ellipse cx="15804.9" cy="618.475" rx="10.066" ry="7.745" fill="#fff"
                transform="matrix(-.9839 0 0 1.17171 17762.098 -639.646)"></ellipse>
              <ellipse cx="15804.9" cy="618.475" rx="10.066" ry="7.745" fill="#fff"
                transform="matrix(-1.45701 -.02353 -.0262 1.6223 25234.314 -550.184)"></ellipse>
              <path
                ...
                fill="#eca19a" transform="translate(-16671.478 -1287.763) scale(1.06068)"></path>
              <path
                ...
                fill="#da4c3f" fill-rule="nonzero" transform="matrix(2.5787 0 0 1.48837 -4272.15 -3505.654)"></path>
              <g transform="translate(-16668.478 -1287.763) scale(1.06068)">
                <path
                  d="M17680 1379.75c.2.79 48.9-4.14 59.7-42.02 0 0 6.3.68 11.6-7.09v2.5c.6 23.29 18.5 42.47 41.7 44.61 8 .74 14 1.29 14 1.29-38.7 12.9-83.9 15.27-127 .71z"
                  fill="#fff"></path>
                <clipPath id="_clip1">
                  <path
                    d="M17680 1379.75c.2.79 48.9-4.14 59.7-42.02 0 0 6.3.68 11.6-7.09v2.5c.6 23.29 18.5 42.47 41.7 44.61 8 .74 14 1.29 14 1.29-38.7 12.9-83.9 15.27-127 .71z">
                ...
                <g clip-path="url(#_clip1)">
                  <path
                    ...
                    fill="#da4c3f" fill-rule="nonzero" transform="matrix(.8442 .03279 -.01756 .45202 15676.4 162.548)">
                  </path>
                  <path
                    ...
                    fill="#da4c3f" fill-rule="nonzero" transform="matrix(1.34373 0 0 .71777 14388.4 -407.72)"></path>
                </g>
              </g>
              <path d="M17697.8 1376.98c13.9-4.45 34.8-15.04 41.9-39.25.3-1.05.5-2 .7-2.88" fill="none" stroke="#da4c3f"
                stroke-width="1.91" transform="matrix(1.07824 0 0 1.0188 -16979.979 -1231.733)"></path>
              <path
                ...
                fill="#fff" transform="translate(-22103.79 -1695.683) scale(1.36692)"></path>
              <path
                ...
                fill="#da4c3f" fill-rule="nonzero" transform="matrix(1.26742 0 0 1.5828 -20338.886 -1978.883)"></path>
              <path
                ...
                fill="#da4c3f" fill-rule="nonzero" transform="matrix(1.18525 0 0 1.07708 -18869.683 -1313.343)"></path>
              <path
                ...
                fill="#da4c3f" transform="translate(-24254.195 -1853.983) scale(1.48815)"></path>
              <path
                ...
                fill="#da4c3f" fill-rule="nonzero" transform="matrix(.84272 -.14186 .11908 .70736 -241.727 -1250.943)">
              </path>
              <path
                ...
                fill="#fff" fill-rule="nonzero" transform="matrix(1.06398 0 0 1.28852 -20273.186 -1580.533)"></path>
              <path
                ...
                fill="#fff" fill-rule="nonzero" transform="matrix(.43573 0 0 .86161 -6995.477 -993.494)"></path>
              <path
                ...
                fill="#da4c3f" transform="matrix(.9623 -1.11826 1.11826 .9623 -19589.285 22394.01)"></path>
              <circle cx="21134.2" cy="1315.25" r="1.75" fill="#fff"
                transform="matrix(1.23648 -.26496 .26496 1.23648 -24258.495 4108.01)"></circle>
              <g>
                <path
