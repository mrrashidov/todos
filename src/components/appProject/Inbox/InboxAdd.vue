  ...
  >
          ...
          >
            <router-link to="comments">
              <div class="flex">
                ...
                <span class="lg:block xl:block 2xl:block hidden">
                  Comments</span
                >
              </div>
            </router-link>
    ...
    <div class="w-full">
      <div
        ...
        "
      >
        <label for="inp" class="font-bold text-lg text-red-600 cursor-pointer"
          >Add Section</label
        >
      </div>
      ...
      <div v-else class="section w-full">
        ...
        <button
          @click="addSection"
          class="bg-red-600 py-2 px-3 my-2 text-white font-bold rounded-md"
        >
          Add section
        </button>
        <button
          @click="cancelSection"
          class="mx-2 mt-2 py-2 px-3 hover:underline"
        >
          Cancel
        </button>
      </div>
          ...
          <g transform="translate(-2050)">
            <g id="InboxZero">
              <path
                ...
                transform="matrix(.73333 0 0 .66667 730 66.667)"
              ></path>
              <path
              ...
              <ellipse
                ...
                ry="7.745"
                fill="#fff"
                transform="matrix(-1.56686 0 0 1.87728 26893.318 -1080.936)"
              ></ellipse>
              <path
                d="M15804.9 610.729c5.6 0 10.1 3.471 10.1 7.746h-20.2c0-4.275 4.6-7.746 10.1-7.746z"
                fill="#fff"
                transform="matrix(-3.22859 0 0 4.12745 53186.476 -2458.803)"
              ></path>
              <ellipse
                cx="15804.9"
                cy="618.475"
                ...
                ry="7.745"
                fill="#fff"
                transform="matrix(-1.05711 0 0 1.29581 18813.8 -716.811)"
              ></ellipse>
              <path
              ...
              <ellipse
                ...
                ry="7.745"
                fill="#fff"
                transform="matrix(-.9839 0 0 1.17171 17762.098 -639.646)"
              ></ellipse>
              <ellipse
                cx="15804.9"
                cy="618.475"
                ...
                ry="7.745"
                fill="#fff"
                transform="matrix(-1.45701 -.02353 -.0262 1.6223 25234.314 -550.184)"
              ></ellipse>
              <path
              ...
              <circle
                ...
                r="1.75"
                fill="#fff"
                transform="matrix(1.23648 -.26496 .26496 1.23648 -24258.495 4108.01)"
              ></circle>
              <g>
                <path
