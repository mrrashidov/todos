...
<template>
    <div>
        ...
        <div class="flex mt-1">
            <div
                    class="bg-gray-200 md:w-20 text-center cursor-pointer rounded md:pt-1 md:pb-1"
