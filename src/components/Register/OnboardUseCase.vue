    ...
    <div class="mt-10 w-4/5 mx-auto flex flex-wrap h-auto">
      ...
      <form class="w-4/5 mx-auto h-full flex justify-center flex-wrap">
        ...
        >
          ...
          <img :src="item.url" :alt="item.title" class="text-center mt-5" />
          <h1 :key="item.id" class="text-xl font-primary text-center mt-2">
            {{ item.h_1 }}
          </h1>
        </div>
        <div
        ...
        <button
          ...
          class="w-24 border h-8 disabled:opacity-30 bg-red mx-auto rounded-md text-white mt-5 font-semibold"
        >
          Continue
        </button>
      </form>
...
import ModalOnboardUseCase from "./ModalOnboardUseCase.vue";
import { useRouter } from "vue-router";
import { ref } from "vue";
const router = useRouter();

const OnboardProficiency = () => {
  router.push("/app/onboard/proficiency");
};
...
function enable() {
  ...
  let check_1 = elementA.value[1].checked;
