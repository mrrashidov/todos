<template>
  <div class="w-screen max-w-full h-auto bg-[#FFF9F3] mt-10">
    ...
    >
      <div class="mr-20">
        <img src="@/public/footer.png" alt="img" class="w-96 mb-20" />
      </div>
    ...
    >
      ...
      >
        ...
        <img src="@/public/copyright.png" alt="image" class="w-3 h-3 ml-3" />
      ...
      >
        <img src="@/public/internet.png" alt="image" class="w-5 h-5 ml-3" />
