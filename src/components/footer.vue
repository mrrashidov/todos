<template>
  <div class="w-screen max-w-full h-auto bg-[#FFF9F3] mt-10">
        ...
        <div class="w-[300px] h-[150px] flex flex-wrap">
            ...
            >
              ...
              <g fill="none" fill-rule="evenodd">
                <path
                  ...
                  fill="#000000"
                  mask="url(#td-logo-wordmark_svg__a)">
                </path>
                <g fill="#fff">
                  <path
          ...
          <ul
           ...
           <li v-for="item in footer_icons" :key="item.id">
            <a :href="item.href">
              <svg :class="item.class" :width="item.width" :alt="item.alt" :height="item.height" :viewBox="item.viewBox" :xmnls="item.xmlns"><path :d="item.d" :fill="item.fill" :file-rule="item.fill_rule" :clip-rule="item.clip_rule"/></svg>
            </a>
           </li>        
          </ul>
        </div>
    ...
    >
      ...
      >
        <p class="text-lg text-[#575757] cursor-pointer">Security</p>
        <div
          class="border-[1px] border-solid border-[#6b6b6b] w-[0px] h-[12px]"></div>
        <p class="text-lg text-[#575757] cursor-pointer">Privacy</p>
        <div
          class="border-[1px] border-solid border-[#6b6b6b] w-[0px] h-[12px]"></div>
...
const footer_icons = [
  {
    id:1,
    class:"rounded-full transition ease-in-out delay-10 fill-none bg-[#575757] hover:bg-[#000000]",
    alt:'facebook',
   ...
   {
    id:2,
    class:"fill-[#575757] transition ease-in-out delay-10 hover:fill-[#000000]",
    alt:'instagram',
