      ...
      <div class="bg-redish flex px-[3vw] py-1 justify-between">
        <div class="flex items-center">
          <div @click="store.$state.asideMenu = !store.$state.asideMenu"
            ...
            <svg class="menu_icon text-white" width="24" height="24" viewBox="0 0 24 24">
          ...
          <div class="hover:bg-appHeaderHover rounded-md p-1 cursor-pointer">
          ...
          <div>
            <div class="relative rounded-md shadow-sm mx-0.5">
        ...
        <div class="flex items-center">
          <div class="hover:bg-appHeaderHover rounded-md p-1 mx-0.5 cursor-pointer">
            <svg @click="gull" class="text-white" width="24" height="24" viewBox="0 0 24 24">
          ...
          <div class="
            flex
            text-white
            hover:bg-appHeaderHover
            rounded-md
            p-1
            cursor-pointer
          ">
            <svg viewBox="-2 -2 4 4" style="transform: rotate(-90deg); width: 24px; height: 24px">
              <circle cx="0" cy="0" r="1.4" fill="none" visibility="visible" stroke="currentColor" stroke-width="0.2">
              </circle>
              <path fill="currentColor" d="M 1 0 A 1 1 0 1 1 -0.8090169943749475 -0.587785252292473 L 0 0"></path>
            </svg>
            <span>3/5</span>
          </div>
          <div class="
          ...
          <div class="user_avatar big settings_avatar mx-0.5">
            <img
              @click="store.accShow = !store.accShow" 
