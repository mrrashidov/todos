  ...
  <div class="md:w-4/5 z-20 md:pr-32 md:pl-28 overflow-x-hidden">
    <div class="flex items-end justify-between md:">
      <div class="flex items-center">
        ...
        <p class="text-xs md:mt-1 md:ml-2 text-gray-500">
          {{ week }} {{ day }} {{ fullMonth }}
        </p>
      </div>
      <div
        ...
        class="
          ...
          rounded
          w-auto
          md:pt-0.5 md:pb-0.5 md:pl-1 md:pr-2
          cursor-pointer
          hover:bg-gray-200
          flex
          items-center
      ...
      <div class="text-center mt-3">
        ...
        <button
          class="
            ...
            rounded
            text-sm
            md:pr-3 md:pl-3 md:pt-1 md:pb-1
          "
        >
          Add atask
        </button>
          ...
          <svg width="24" height="24">
            <defs>
              <path
                ...
                id="4971afb8-c365-4956-af3a-823b17fe66ee"
              ></path>
            </defs>
            <g fill="none" fill-rule="evenodd">
              ...
              <g
                mask="url(#f0b1843e-0058-447e-908f-823b17fe66cb)"
                fill="#FF9233"
              >
        ...
        <a
          href="#"
          class="text-red-500 md:mt-2 text-sm inline-flex items-center"
        >
